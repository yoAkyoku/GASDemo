...
template<> VRM4U_API UScriptStruct* StaticStruct<FImportOptionData>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_AnimationTranslateScale = { "AnimationTranslateScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FImportOptionData, AnimationTranslateScale), METADATA_PARAMS(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_AnimationTranslateScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_AnimationTranslateScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_PlayRateScale = { "PlayRateScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FImportOptionData, PlayRateScale), METADATA_PARAMS(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_PlayRateScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_PlayRateScale_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bForceOriginalBoneName = { "bForceOriginalBoneName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FImportOptionData), &Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bForceOriginalBoneName_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bForceOriginalBoneName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bForceOriginalBoneName_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bSkipPhysics = { "bSkipPhysics", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FImportOptionData), &Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bSkipPhysics_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bSkipPhysics_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bSkipPhysics_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bUseUE5Material = { "bUseUE5Material", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FImportOptionData), &Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bUseUE5Material_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bUseUE5Material_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FImportOptionData_Statics::NewProp_bUseUE5Material_MetaData)) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::ScriptStructInfo[] = {
		{ FImportOptionData::StaticStruct, Z_Construct_UScriptStruct_FImportOptionData_Statics::NewStructOps, TEXT("ImportOptionData"), &Z_Registration_Info_UScriptStruct_ImportOptionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FImportOptionData), 2993140976U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_2491738616(TEXT("/Script/VRM4U"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_GASDemo_Plugins_VRM4U_Source_VRM4U_Public_VrmUtil_h_Statics::EnumInfo));
